    ...
    <div class="CENTER">
        ...
        <form action="/adminCtrl" method="post">
            <div id="dynamicInput">
                ...
                <input type="radio" name="csgrad[0]" id="yes" value="yes">
                <label for="no">no</label>
                <input type="radio" name="csgrad[0]" id="no" value="no">

                New Graduate:
                <label for="yesnew">yes</label>
                <input type="radio" name="newgrad[0]" id="yesnew" value="yes">
            ...
            <input type="hidden" name="NomCount" value="1">
