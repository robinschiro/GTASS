...
<div class="WRAPPER">
    ...
    <div class="CENTER">
        ...
        <form action="/nomCtrl" method="post">
            ...
            <!-- Nominee 2 -->
            <label for="fname">First Name: </label>
            <input type="text" name="fname[1]" placeholder="Nominee's First Name" id="fname">
            <label for="lname">Last Name: </label>
            <input type="text" name="lname[1]" placeholder="Nominee's Last Name" id="lname">
            <label for="pid">PID: </label>
            <input type="text" name="pid[1]" placeholder="Nominee's PID" id="pid">
            <label for="email">Email: </label>
            <input type="text" name="email[1]" placeholder="Nominee's Email" id="email">
            <label for="rank">Rank Nominee: </label>
            <input type="number" name="rank[1]" placeholder="Rank" min="0" max="100" id="rank">

            CS Graduate:
            <label for="yes1">yes</label>
            <input type="radio" name="csgrad[1]" id="yes1" value="1">
            <label for="no1">no</label>
            <input type="radio" name="csgrad[1]" id="no1" value="0">

            New Graduate:
            <label for="yesnew">yes</label>
            <input type="radio" name="newgrad[1]" id="yesnew" value="1">
            <label for="nonew">no</label>
            <input type="radio" name="newgrad[1]" id="nonew" value="0">
            ...
            <input type="hidden" name="NomCount" value="2">
