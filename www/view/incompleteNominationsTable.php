<?php
    ...
    $nomineesApprovalNeeded = $nominatorCtrl->nominationServ->getNomineesRequiringApproval($currentSessionID);
    $nomineesResponseNeeded = $nominatorCtrl->nominationServ->getNomineesThatNeverResponded($currentSessionID);
